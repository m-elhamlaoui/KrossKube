...
/**
 * This is the item provider adapter for a {@link runtime.Namespace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamespaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RuntimePackage.Literals.NAMESPACE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Namespace_labels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Namespace_labels_feature", "_UI_Namespace_type"),
				 RuntimePackage.Literals.NAMESPACE__LABELS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAnnotationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Namespace_annotations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Namespace_annotations_feature", "_UI_Namespace_type"),
				 RuntimePackage.Literals.NAMESPACE__ANNOTATIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Namespace.class)) {
			case RuntimePackage.NAMESPACE__NAME:
			case RuntimePackage.NAMESPACE__LABELS:
			case RuntimePackage.NAMESPACE__ANNOTATIONS:
