...
/**
 * This is the item provider adapter for a {@link runtime.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addContainerPortPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RuntimePackage.Literals.PORT__NAME,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addContainerPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_containerPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_containerPort_feature", "_UI_Port_type"),
				 RuntimePackage.Literals.PORT__CONTAINER_PORT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RuntimePackage.Literals.PORT__PROTOCOL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHostPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_hostPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_hostPort_feature", "_UI_Port_type"),
				 RuntimePackage.Literals.PORT__HOST_PORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Port.class)) {
			case RuntimePackage.PORT__NAME:
			case RuntimePackage.PORT__CONTAINER_PORT:
			case RuntimePackage.PORT__PROTOCOL:
			case RuntimePackage.PORT__HOST_PORT:
