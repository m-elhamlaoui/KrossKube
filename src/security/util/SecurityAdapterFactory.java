...
public class SecurityAdapterFactory extends AdapterFactoryImpl {
	...
	protected SecuritySwitch<Adapter> modelSwitch =
		new SecuritySwitch<Adapter>() {
			...
			@Override
			public Adapter caseServiceAccount(ServiceAccount object) {
				return createServiceAccountAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link security.Role <em>Role</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link security.ServiceAccount <em>Service Account</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createServiceAccountAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link security.RoleBinding <em>Role Binding</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
