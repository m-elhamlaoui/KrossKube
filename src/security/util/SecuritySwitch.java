...
public class SecuritySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SecurityPackage.SERVICE_ACCOUNT: {
				ServiceAccount serviceAccount = (ServiceAccount)theEObject;
				T result = caseServiceAccount(serviceAccount);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SecurityPackage.ROLE_BINDING: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Account</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Account</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceAccount(ServiceAccount object) {
		return null;
	}
