...
public class StorageAdapterFactory extends AdapterFactoryImpl {
	...
	protected StorageSwitch<Adapter> modelSwitch =
		new StorageSwitch<Adapter>() {
			@Override
			public Adapter caseExternalStorage(ExternalStorage object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link storage.ExternalStorage <em>External Storage</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExternalStorageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link storage.PersistentVolume <em>Persistent Volume</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link storage.PersistentVolumeClaim <em>Persistent Volume Claim</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link storage.Volume <em>Volume</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
