...
public class ConfigPackageImpl extends EPackageImpl implements ConfigPackage {
	 ...
	 */
	@Override
	public EAttribute getSecret_Data() {
	...
	public void createPackageContents() {
		...
		createEAttribute(secretEClass, SECRET__DATA);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConfigMap_Data(), ecorePackage.getEString(), "data", null, 0, -1, ConfigMap.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(secretEClass, Secret.class, "Secret", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSecret_Data(), ecorePackage.getEString(), "data", null, 0, -1, Secret.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
