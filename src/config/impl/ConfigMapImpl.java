 ...
 * </p>
 * <ul>
 *   <li>{@link config.impl.ConfigMapImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigMapImpl extends MinimalEObjectImpl.Container implements ConfigMap {
	...
	protected EClass eStaticClass() {
		return ConfigPackage.Literals.CONFIG_MAP;
	}
	...
	public EList<String> getData() {
		if (data == null) {
			data = new EDataTypeUniqueEList<String>(String.class, this, ConfigPackage.CONFIG_MAP__DATA);
		}
		return data;
	}
